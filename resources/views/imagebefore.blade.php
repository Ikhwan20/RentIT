...
<html>
  ...
  <body class="bg-gray-200 h-screen flex items-center justify-center">
    <form class="bg-white p-6 rounded-lg shadow-md" action="{{ url('uploadbefore') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <h1 class="text-lg font-medium mb-4">Upload Image Before</h1>
