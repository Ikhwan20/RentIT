<nav class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
              ...
              @if (Route::has('login'))
                <div class="fixed right-0 mr-20 mt-2 sm:block">
                    @auth
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    @else
                    <div class="mt-5 mr-5">
                        <a href="{{ route('login') }}" class="text-m text-black dark:text-gray-500 underline">Log in</a>
    ...
    <nav class="navbar navbar-expand-lg border-bottom bg-white border-b border-gray-100" id="lower-navbar">
        <div class="container">
